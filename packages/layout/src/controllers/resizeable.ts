...
export class Resizeable implements ReactiveController {
    ...
    private handleMouseDown(e: MouseEvent) {
        ...
        // 检查并更新配置
        if ('getResizeableOptions' in this.host &&
            typeof (this.host as any).getResizeableOptions === 'function') {
    ...
    private _onResize(width: number, height: number) {
        if ('onResize' in this.host &&
            typeof (this.host as any).onResize === 'function') {
